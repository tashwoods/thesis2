...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.48\hsize]{figures/results/HVTWW/PlotyieldTable_postfit.pdf}
    \includegraphics[width=0.48\hsize]{figures/results/HVTWZ/PlotyieldTable_postfit.pdf}
 \caption{The distribution of $m_{\ell\nu qq}$ in the DY $WW(WZ)$ control regions on the left(right).} 
...
\begin{figure}[h!]
 ...
 \caption{The distribution of $m_{\ell\nu qq}$ in the VBF $WW$ Tag signal regions.} 
